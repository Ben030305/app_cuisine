...
<article id="post-3219" className="cocotte">
...
<article id="post-3219" className="banane">

	
			<div className="post-image">
				<img width="300" height="auto" src="assets/banane.jpg" alt="Banane" decoding="async" />			</div>
...
<article id="post-3219" className="haricot">

	
			<div className="post-image">
				<img width="300" height="auto" src="assets/haricot.png" alt="Cocotte en fonte" decoding="async" />			</div>
