      ...
      <IonContent fullscreen>
        ...
        <IonList class='article_explorer'>
          <IonItem routerLink='/article' className='item_explorer'>
            <IonImg class='item_image_explorer' src='resources/icon.png' alt='Article 1'></IonImg>
          ...
          <IonItem routerLink='/article/2' className='item_explorer'>
            <IonImg class='item_image_explorer' src='resources/icon.png' alt='Article 2'></IonImg>
          ...
          <IonItem routerLink='/article/3' className='item_explorer'>
            <IonImg class='item_image_explorer' src='resources/icon.png' alt='Article 3'></IonImg>
