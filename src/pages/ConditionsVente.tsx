...
const cgv = <div className="post-content">
        <p></p>
        <h2 className='sous_titre'>Article 1 : Champ d’application</h2>
        ...
        <h2 className='sous_titre'>Article 4 : Paiement</h2>
        ...
        <h2 className='sous_titre'>Article 5 : Accès et livraison</h2>
        ...
        <h2 className='sous_titre'>Article 6 : Droit d’auteur</h2>
        ...
        <h2 className='sous_titre'>Article 7 : Conditions de remboursement</h2>
        ...
        <h2 className='sous_titre'>Article 8 : Protection des données personnelles</h2>
        ...
        <h2 className='sous_titre'>Article 9 : Limitation d’âge</h2>
        ...
        <h2 className='sous_titre'>Article 10 : Informations sur la société</h2>
